...
<body>
	...
	<header>
		...
		<div class="heroe">
			...
			<h1>Hello Asrul, Welcome to CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

			<h2>The small framework with powerful features. You now can eat well and write freely.</h2>
